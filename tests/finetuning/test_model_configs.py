...
MODEL_CONFIGS = (
    Path("configs/shared/models/qwen25_coder_7b_hf.yaml"),
    Path("configs/shared/models/qwen25_coder_7b_hf_wsl.yaml"),
    Path("configs/shared/models/qwen25_coder_7b_ollama.yaml"),
)
