...
Tieto súbory evidujú root, očakávaný počet prípadov, task a execution protokol.
`testbench.yaml` navyše zmrazuje direct Ollama sampling parametre, Maven timeout,
