...
TRAINING_SCRIPT = Path("scripts/finetuning/train_finetuning.py")
...
def main() -> None:
    ...
    if args.config:
        ...
        print("[INFO] For WSL, prefer: python scripts/finetuning/check_finetuning_ready.py --config configs/finetuning/<experiment>_wsl.yaml")
