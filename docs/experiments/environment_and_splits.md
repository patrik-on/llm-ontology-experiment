...
`configs/shared/environment/rag_baseline_windows_cpu.lock.json`; the complete Python
package lock is `configs/shared/environment/requirements-rag-windows-cpu.lock.txt`.
...
```powershell
python scripts/datasets/audit_group_splits.py `
